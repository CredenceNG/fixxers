...
export function CreateGigForm({ categories }: { categories: Category[] }) {
  ...
  const [packages, setPackages] = useState<PackageData[]>([
    { name: 'Basic', description: '', price: '', deliveryDays: '', revisions: '1', features: [''] },
    { name: 'Standard', description: '', price: '', deliveryDays: '', revisions: '2', features: [''] },
    { name: 'Premium', description: '', price: '', deliveryDays: '', revisions: '3', features: [''] },
  ]);
